...
This repo packages the Delx Wellness OpenClaw profile, onboarding, skills and MCP connector presets.
...
- Never commit OpenClaw local profiles, model credentials, MCP tokens, OAuth secrets, or personal health data.
